...
[~,~,~,p_est,~] = sysid_module(p_star,n,q0,u,v,p0,Sigma0/sigma_v,alpha);
plot(p_est(1,:)); 

alpha = 0.995;       % forgetting factor
[~,~,~,p_est,~] = sysid_module(p_star,n,q0,u,v,p0,Sigma0/sigma_v,alpha);
plot(p_est(1,:)); 
...
legend('$\alpha=1$','$\alpha=0.995$','$\alpha=0.8$','True','Fontsize',16,'Interpreter','latex')
